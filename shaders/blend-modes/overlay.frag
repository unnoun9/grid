...
void main()
{
    ...
    vec4 blendedColor = vec4(
        (color1.r > 0.5) ? (1.0 - (1.0 - 2.0 * (color1.r - 0.5)) * (1.0 - color2.r)) : (2.0 * color1.r * color2.r),
        (color1.g > 0.5) ? (1.0 - (1.0 - 2.0 * (color1.g - 0.5)) * (1.0 - color2.g)) : (2.0 * color1.g * color2.g),
        (color1.b > 0.5) ? (1.0 - (1.0 - 2.0 * (color1.b - 0.5)) * (1.0 - color2.b)) : (2.0 * color1.b * color2.b),
        color1.a
    );
